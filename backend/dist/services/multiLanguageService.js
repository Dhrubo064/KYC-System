...
exports.multiLanguageService = exports.MultiLanguageService = void 0;
...
class MultiLanguageService {
     ...
     */
    async translateSummary(summary, languages) {
        try {
            ...
            try {
                const translations = await llmService_1.llmService.translateSummaryToMultipleLanguages(summary, languages);
    ...
    async translateText(text, targetLanguage, sourceLanguage = 'English') {
        try {
            ...
            try {
                const translated = await llmService_1.llmService.translateText(text, targetLanguage, sourceLanguage);
    ...
    async detectLanguage(text) {
        try {
            ...
            try {
                const detectedLanguage = await llmService_1.llmService.detectLanguage(text);
     ...
     */
    async translateKYCResponse(summary, rejectionReason, targetLanguage) {
        try {
            if (!process.env.ANTHROPIC_API_KEY || process.env.USE_LLM_TRANSLATION !== 'true') {
...
exports.multiLanguageService = new MultiLanguageService();
