          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 rounded-lg hover:shadow-lg transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {loading ? (
                  <>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-t-2 border-blue-100">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1"><strong>Admin:</strong> admin@kyc.com / admin123</p>
                <p className="text-xs text-gray-600"><strong>User:</strong> user@example.com / User123456</p>
              </div>
            </div>
          </div>
        </div>
